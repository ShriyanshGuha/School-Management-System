...
public class FacultyHomePage extends JFrame {
    ...
    public FacultyHomePage() {
        ...
        ImageIcon bgIcon = new ImageIcon("C:\\Users\\shriy\\OneDrive\\Desktop\\JavaProjects\\SchoolManagementSystem\\src\\icons\\Faculty.jpg");
        ...
        String[] menus = {"Teacher Profile", "Student Profile", "Marks Details", "Logout"};
        for (String name : menus) {
            ...
            if (name.equals("Teacher Profile")) {
                menu.add(new JMenuItem("View Teacher Profile"));
                menu.add(new JMenuItem("Edit Teacher Profile"));
            } else if (name.equals("Student Profile")) {
                menu.add(new JMenuItem("Mark Student Profile"));
                menu.add(new JMenuItem("View Student Profile"));
            } else if (name.equals("Marks Details")) {
                menu.add(new JMenuItem("View Marks Details"));
                menu.add(new JMenuItem("Schedule Class"));
